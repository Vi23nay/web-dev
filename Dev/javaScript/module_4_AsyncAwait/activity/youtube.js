...
(async function fn() {
    try{
        ...
        //***************playlist name  ************************/
        let element = await page.$("h1[id = 'title']");//single element '$'
        ...
        let playlistDetails = await page.$$(".style-scope.ytd-playlist-sidebar-primary-info-renderer");//$$ -> gives array of elements
